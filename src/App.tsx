      ...
      {!openedEnvelope && (
        <div className="container-r relative">
          ...
          <div className="flex flex-col">
            <div
              className={`content-r z-20 ${isOpenCard ? "" : "animate-bounce"}`}
            >
              ...
              >
                <div className="message text-gray-700">
                  ...
                  <p className="mt-3 font-serif">
                    Dengan segala kerendahan hati, izinkan kami berbagi kabar
                    bahagia ini kepada Sahabat dan Keluarga tercinta.
                  </p>
                  <button
                      ...
                      <div className="space-y-6">
                        ...
                        {currentChapter === 1 && (
                          ...
                          >
                            ...
                            <p className="text-sm leading-relaxed max-w-xs mx-auto">
                              Dan di antara tanda-tanda kekuasaan-Nya lah Dia
                        ...
                        {currentChapter === 2 && (
                          ...
                          >
                            <div className="text-2xl mb-2">"</div>
                            <p className="text-sm leading-relaxed max-w-xs mx-auto">
                              Doa tulus Anda adalah hadiah terindah, namun bila
                              ingin berbagi kebahagiaan dalam bentuk lain, kami
                              dengan penuh syukur akan menerimanya.
                            </p>
                            <div className="text-2xl mt-2">"</div>
                          </div>
                        )}
                        {currentChapter === 3 && (
                          ...
                          >
                            <div className="text-2xl mb-2">"</div>
                            <p className="text-sm leading-relaxed max-w-xs mx-auto">
                              Hari istimewa kami akan lebih sempurna dengan doa
                              dan kehadiran Anda. Silakan konfirmasi kehadiran
                              agar momen ini kian berkesan
                            </p>
                            <div className="text-2xl mt-2">"</div>
                          </div>
                        )}
